...
export interface MermaidImportProps {
  loaded: boolean;
  api: Promise<{
...
const MermaidImport = () => {
  ...
  const [mermaidImportLib, setMermaidImportLib] =
    useState<MermaidImportProps>({
      loaded: false,
      api: Promise.resolve({
  ...
  useEffect(() => {
    const convertMermaid = async () => {
      try {
        const api = await mermaidImportLib.api;
        let ret;
        try {
    ...
    <>
      ...
      <TTDDialogPanels>
        ...
        >
          <TTDDialogOutput
            value={value}
            loaded={mermaidImportLib.loaded}
            error={error}
          />
        </TTDDialogPanel>
      </TTDDialogPanels>
