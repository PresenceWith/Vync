...
**Post-MVP 안정화** · 95 tests PASS · 2026-03-16 갱신
...
| 기획 | Graph View (온톨로지 편집기) | F-008 | [제안](./plans/2026-03-14-graph-view-proposal.md) |
| 분석 완료 | 토큰 최적화 | F-014 | [분석](./plans/2026-03-13-token-optimization.md) |
| 검증 완료 | Semantic Sync 회귀 검증 | I-005 | [결과](./plans/2026-03-14-semantic-sync-regression.md) |
...
| 2 | F-008 Graph View | 🔍 evaluating | L | 기존 캔버스와 독립. PoC 진행 중 |
| 3 | F-006 Document Package | 🔍 evaluating | XL | Breaking change. 신중한 평가 필요 |
| 4 | F-014 토큰 최적화 | 🔍 evaluating | M | 분석 완료, 구현 우선순위 미결정 |
